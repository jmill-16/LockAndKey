...
public class EnemyPatrol2B : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if(Vector3.Distance(transform.position, currentPoint.position) < 3f && currentPoint == pointB.transform)
        {
        ...
        if(Vector3.Distance(transform.position, currentPoint.position) < 3f && currentPoint == pointA.transform)
        {
